...
1. **Configuration**: Define your PHP versions and their paths in `php-runner.map`
...
Create `php-runner.map` in the same directory as the executable or in your home dir:
...
3. Create `php-runner.map` in the same directory
